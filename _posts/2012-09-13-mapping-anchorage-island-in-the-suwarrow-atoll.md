...
The next step was preparation for actually taking the fixes on the island. I numbered the points we had marked on the little "baguette sketch" and then cerated a table with one column for latitude and one column for longitude  for each of the points. I also added a column for comments (in case we needed to note something special for a fix) and left enough space for adding other points. Then we thought about how to record latitude and longitude values. These are measured in degrees, minutes, and fractions of a minute. For example, our boat is currently anchored at
    ...
    latitude:    13 degrees 14.906 minutes South
    longitude:  163 degrees 06.463 minutes West
...
[![Planning the mapping exercise](/sites/default/files/nicky_page/suwarrow_baguette_sketch.jpg)](/sites/default/files/nicky_page/suwarrow_baguette_sketch.jpg)
...
[![Anchorage Island Map](/sites/default/files/nicky_page/suwarrow_anchorage_island_map.jpg)](/sites/default/files/nicky_page/suwarrow_anchorage_island_map.jpg)
...
[![Map of the anchorage with depth soundings](/sites/default/files/nicky_page/suwarrow_anchorage_map.jpg)](/sites/default/files/nicky_page/suwarrow_anchorage_map.jpg)
*Map of the anchorage*

The most difficult parts in creating these maps were:

* Figuring out the scale, that is how many units (0.001 minutes of latitude and longitude) to use per square (because it's a bit complicated)
* Transferring the fixes correctly (because each point has lots of digits, you need to think about which way negative values go and because it's difficult to find the correct latitude and longitude in the middle of the grid, away from the axes) 
* When we charted the anchorage taking the data was difficult because the dinghy was drifting and we also had to take depth measurements (and we had Niclas and Hannes from Victoria helping, so we had more people to coordinate)
The most fun parts of doing the maps were...
* Taking the GPS fixes
* Connecting the dots to get the map
* Coloring in the different depths in the anchorage chart


What I would do differently if I were to do it again

* Take more depth measurements
* Anchor the dinghy when taking the measurements
* Label the axes on either side (and maybe even in the middle) to make it easier to transfer the points correctly


Useful things I learned :

* The different depths in the anchorage
* How to draw a grid at the right scale
* How to draw GPS points on the grid
* It's a good idea to work very neatly because it makes it easier
* It's important to double check your work after each major step